...
//create one higher order function  that will take above functions as call back.Its gonna check if arguments received are numbers and then invoke the call back function. which can change arguments to numbers
...
//create a function that lets us apply discount based off of inventory 

const applyDiscountByLimitedInventory = (arr,callbacl,discount,amount) = {
    arr.forEach(product=> {
...
console.log(dogProducts)
////////////////////////
////// SANDWICHES ////// higherorder function
////////////////////////

// CODE HERE
// create a function called makesandwich
